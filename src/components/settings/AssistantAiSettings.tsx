  ...
  async function detectAndSave(profile: ModelProfile, closeDraft: boolean) {
    ...
    try {
      ...
      const updated: ModelProfile = {
        ...
        ...(selected.providerModelName ? { providerModelName: selected.providerModelName } : {}),
